...
```gradle
dependencies {
    implementation 'com.github.apiverve:advice-api:1.1.12'
}
```
...
```java
import com.apiverve.advice.AdviceGeneratorAPIClient;
import com.apiverve.advice.APIResponse;
import com.apiverve.advice.APIException;

// Initialize the client
AdviceGeneratorAPIClient client = new AdviceGeneratorAPIClient("YOUR_API_KEY");
